from RecordUpdate import cursorUpdate
...
def update_patient(patient_id, first_name=None, last_name=None, date_of_birth=None):
    ...
    return cursorUpdate(update_formula, tuple(values))
...
def update_visit(visit_id, visit_date):
    ...
    return cursorUpdate(update_formula, (visit_date, visit_id))
...
def update_symptom(symptom_id, symptom_name):
    ...
    return cursorUpdate(update_formula, (symptom_name, symptom_id))
...
def update_medicine(medicine_id, medicine_name):
    ...
    return cursorUpdate(update_formula, (medicine_name, medicine_id))
...
def update_disease(disease_id, disease_name):
    ...
    return cursorUpdate(update_formula, (disease_name, disease_id))
